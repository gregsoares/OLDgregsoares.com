  ...
  return (
    <div className='max-w-2xl mx-auto overflow-hidden rounded-md shadow-md brand-lighterBlue'>
      ...
      <div className='mt-2 text-center text-grey-darker'>
        <h3 className='mb-4  '>
          <button className='w-full py-4 my-8 tracking-wide text-blue-600 border rounded shadow-md brand-blue-gradient hover:border-white hover:border-2 hover:text-white hover:shadow-lg'>
            Live Preview
          </button>
        </h3>
      </div>
