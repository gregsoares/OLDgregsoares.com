...
export const Card = (props) => {
  return (
    <div
      className="w-auto py-0 mx-auto my-0 bg-white rounded-md shadow-md y-8 border-1"
      ...
      <div className="max-w-sm p-1 mx-auto rounded shadow-lg">
        ...
        <div className="px-6 py-4">
          ...
          <p className="text-base text-gray-600">
            ...
            elit. Esse quae optio animi ex necessitatibus non, suscipit illum
            corporis. Nam, doloribus.
          </p>
        </div>
        <div className="px-6 py-4">
