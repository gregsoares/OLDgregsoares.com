    ...
    >
      <div className='pt-8 pb-12 font-medium text-gray-200 xl:font-lg '>
        <div className='w-full px-6 text-center'>
          ...
          <div className='my-4'>
            <a
              className='px-6 py-4 font-bold tracking-wider text-gray-600 uppercase border border-gray-500 rounded-lg shadow-lg hover:border-gray-200 brand-lightBlue hover:bg-topnav hover:text-white hover:shadow-xl'
